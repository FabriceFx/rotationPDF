 ...
 *  Rôle        : Initialisation des menus, gestion des feuilles et points d'entrée API.
 *  Version     : 2.0.1
 * ============================================================================
 */
  ...
  const htmlOutput = HtmlService.createHtmlOutput(
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          Assistant de Rotation PDF v${CONFIG.VERSION} - FF Labs
        </div>
      </body>
    </html>`
  )
 ...
 * Charge la sidebar sous forme de template et l'évalue en y passant la locale.
 */
